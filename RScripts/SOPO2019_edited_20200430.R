...
# Script Date: 2020-02
# Edited 2020-04-30 to run with new data
# R Version: 3.6.1
#
...
# connection to local IPES MS Access database
...
volume_ipes_orig <- read_csv(here::here("Input", "2019", "JB_VIEW_IPES_CPUE_BRIDGE_LOG_FIELD_ID.csv"),
                             col_types = cols(
                               TRIP_ID = col_double(),
                               TRIP_NAME = col_character(),
                               TRIP_YEAR = col_double(),
                               BRIDGE_LOG_ID = col_double(),
                               BRIDGE_LOG_FIELD_ID = col_double(),
                               EVENT_DATE = col_character(),
                               STRATUM = col_double(),
                               BLOCK_DESIGNATION = col_double(),
                               EVENT_TYPE = col_character(),
                               EVENT_NUMBER = col_double(),
                               TOW_NUMBER = col_double(),
                               DayNight = col_character(),
                               END_DEPLOYMENT_TIME = col_character(),
                               BEGIN_RETRIEVAL_TIME = col_character(),
                               ...
                               SUB_AREA_CODE = col_character(),
                               PFMA_SUB_AREA_NUMBER = col_character(),
                               START_BOTTOM_DEPTH = col_double(),
                               END_BOTTOM_DEPTH = col_double(),
                               MIN_BOTTOM_DEPTH = col_double(),
                               MAX_BOTTOM_DEPTH = col_double(),
                               AVG_BOTTOM_DEPTH = col_double(),
                               START_GEAR_DEPTH = col_double(),
                               END_GEAR_DEPTH = col_double(),
                               MIN_GEAR_DEPTH = col_double(),
                               MAX_GEAR_DEPTH = col_double(),
                               AVG_GEAR_DEPTH = col_double(),
                               AVG_TOW_DEPTH = col_double(),
                               TARGET_HEADLINE_HEIGHT = col_double(),
                               MOUTH_OPENING_HEIGHT = col_double(),
                               AvgOfMOUTH_OPENING_HEIGHT = col_double(),
                               RBREstNetMouthHeight = col_double(),
                               AvgOfRBRVertical_m = col_double(),
                               OfficialMouthOpeningHeight = col_double(),
                               SPEED = col_double(),
                               DOOR_SPREAD = col_double(),
                               AvgOfDOOR_SPREAD = col_double(),
                               OfficialDoorspread = col_double(),
                               OFFICIAL_DISTANCE_TRAVELLED = col_double(),
                               horizontalOpen_m = col_double(),
                               AvgOfhorizontalOpen_m1 = col_double(),
                               OfficialMouthOpeningWidth = col_double(),
                               OfficialVolSwept_m3 = col_double(),
                               OfficialVolumeSwept_km3 = col_double(),
                               USABILITY_CODE = col_double(),
                               CATCH_ID = col_double(),
                               SPECIES_CODE = col_character(),
                               EST_CATCH_METHOD_CODE = col_double(),
                               TOTAL_CATCH_COUNT = col_double(),
                               JUVENILE_CATCH_COUNT = col_double(),
                               ADULT_CATCH_COUNT = col_double(),
                               TOTAL_CATCH_WEIGHT = col_double(),
                               JUVENILE_CATCH_WEIGHT = col_double(),
                               ADULT_CATCH_WEIGHT = col_double(),
                               CATCH_VOLUME = col_double(),
                               MATURITY_CONVENTION_CODE = col_double(),
                               COMMENTS = col_character(),
                               TotalCatchWtCPUE_kg_km3 = col_double(),
                               JuvCatchWtCPUE_kg_km3 = col_double(),
                               JuvCatchCountCPUE_no_km3 = col_double(),
                               JuvCatchCountCPUE_no_km = col_double()
                             ))
...
## are tows being counted multiple times since multiple species per row? ****
cpueNum_hs_sp <- cpue_hs %>%
  group_by(TRIP_YEAR, EVENT) %>%
  count() %>%
  ungroup() %>%
  group_by(TRIP_YEAR) %>%
  count()
...
# # need to check totals from high seas 
# #  may have counted tows with multiple records (one per species)
# # never used this yearTowVec for SOPO2019
...
ggsave(str_c("Output/2019/CPUE_AllSpecies", str_replace_all(Sys.Date(), "-", ""),".png"))
...
ggsave(str_c("Output/2019/CPUE_AllSpecies_NoZeros", str_replace_all(Sys.Date(), "-", ""),".png"))
...
ggsave(str_c("Output/2019/CPUE_AllSpecies_NoVolume", str_replace_all(Sys.Date(), "-", ""),".png"))
